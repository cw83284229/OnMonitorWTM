...
namespace EquipmentStatus
{
    ...
    //                    AppAlarmManageStates appAlarmManage = httpHelper.GetAlarmManageStates(alarm.Alarm_ID).FirstOrDefault();                       
    ...
    //                        appAlarmManage3.Channel_ID = info.nDefenceID;
    //                        if (alarmdata.Where(u => u.Channel_ID == info.nDefenceID+1).FirstOrDefault() != null)
    //                        {
    //                            appAlarmManage3.Alarm_ID = alarmdata.Where(u => u.Channel_ID  == info.nDefenceID+1).FirstOrDefault().Alarm_ID;
    //                        }
